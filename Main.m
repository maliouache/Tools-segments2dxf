...
% % 	
% % 	Step 4: the dxf file is saved in the current folder that contains the input file segments.txt
addpath([pwd '\DXFlib']);

file=[pwd '\'];
segments=load([pwd '\segments.txt']);

dxffile=[file 'dfn.dxf'];
segments2dxf( segments, dxffile );
